...
var sentences = ["祝常江淋老师开心快乐( ^_^ )",  "拥有温柔美好的未来☺","一切顺利，健康幸福\﻿ (•◡•) /","充满活力，保持热爱(*^__^*)"];
var sentenceIndex = 0;
var points = textToPoints(sentences[sentenceIndex], 17, "幼圆");
setInterval(function() {
  sentenceIndex = (sentenceIndex + 1) % sentences.length;
  points = textToPoints(sentences[sentenceIndex], 17, "幼圆");
